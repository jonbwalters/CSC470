...
# selected pointe and the index used to keep track of location in Shapes list for toggling
selected = pyramid1
...
def backcull(object, polygon):
    perspective = [object.CP[0], object.CP[1], object.CP[2]+d]
    polyvec1 =
    polyvec2 = [polygon[1][0] - polygon[0][0], poly[][] -  ]
    polynormal = [polygon[] ]
...
# will only draw polys that are not back faced culled
